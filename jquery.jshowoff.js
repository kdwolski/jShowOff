		...
		this.each(function(i) {
			...
			function addSlideLinks() {
				...
				$.each(gallery, function(i, val) {
					...
					$('<a class="jshowoff-slidelink-'+i+' '+uniqueClass+'-slidelink-'+i+'" href="#null"><span>'+linktext+'</span></a>').bind('click', {index:i}, function(e){ goToAndPause(e.data.index); return false; }).appendTo('.'+uniqueClass+'-slidelinks');
				});
			};		
